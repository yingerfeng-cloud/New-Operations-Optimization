...
REQUIRED_PARAMETERS = ["electricity_price", "storage_capacity", "charge_power_max", "discharge_power_max"]
OPTIONAL_PARAMETERS = ["charge_efficiency", "discharge_efficiency", "initial_soc", "soc_min"]
API_SKILL_NAME = "run_storage_dispatch"
