...
REQUIRED_PARAMETERS = ["renewable_forecast", "load_forecast", "electricity_price", "storage_capacity", "grid_export_limit"]
OPTIONAL_PARAMETERS = ["charge_power_max", "discharge_power_max", "initial_soc"]
API_SKILL_NAME = "run_renewable_storage_dispatch"
