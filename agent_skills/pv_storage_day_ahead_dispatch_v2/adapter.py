...
REQUIRED_PARAMETERS = ["horizon", "time", "time_volume", "pv_forecast", "grid_limit", "schedule", "price", "storage_power_capacity", "storage_energy_capacity", "initial_soc", "terminal_time", "terminal_soc_target", "capex_power", "capex_energy", "curtailment_penalty", "storage_cycle_cost", "eta_ch", "eta_dis", "delta_t", "soc_min", "deviation_limit", "deviation_penalty_price", "soc_max", "degradation_cost_yuan_per_mwh"]
OPTIONAL_PARAMETERS = []
API_SKILL_NAME = "run_pv_storage_day_ahead_dispatch_v2"
